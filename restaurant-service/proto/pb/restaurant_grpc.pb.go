...
const (
	...
	RestaurantService_GetMyRestaurant_FullMethodName   = "/restaurant.RestaurantService/GetMyRestaurant"
...
type RestaurantServiceClient interface {
	...
	GetMyRestaurant(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RestaurantResponse, error)
...
func (c *restaurantServiceClient) GetMyRestaurant(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RestaurantResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RestaurantResponse)
	err := c.cc.Invoke(ctx, RestaurantService_GetMyRestaurant_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RestaurantServiceServer interface {
	...
	GetMyRestaurant(context.Context, *Empty) (*RestaurantResponse, error)
...
func (UnimplementedRestaurantServiceServer) GetMyRestaurant(context.Context, *Empty) (*RestaurantResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMyRestaurant not implemented")
}
...
func _RestaurantService_GetMyRestaurant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RestaurantServiceServer).GetMyRestaurant(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RestaurantService_GetMyRestaurant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RestaurantServiceServer).GetMyRestaurant(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RestaurantService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMyRestaurant",
			Handler:    _RestaurantService_GetMyRestaurant_Handler,
		},
		{
